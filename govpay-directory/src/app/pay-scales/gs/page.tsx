...
export default function GSPayScalePage() {
  ...
  const jsonLd = {
    ...
    "@type": "Dataset",
    name: "2025 General Schedule (GS) Federal Pay Scale",
    description:
      "Complete GS pay table for 2025 with 15 grades, 10 steps, and locality adjustments for 50+ pay areas. Published by the U.S. Office of Personnel Management.",
              ...
              >
                ...
                {GS_STEPS.map((step) => {
                  ...
                  return (
                    <td
                      key={step}
                      className="px-3 py-2.5 text-right font-[family-name:var(--font-data)] text-xs text-navy-300 transition-colors hover:bg-accent-blue/20 hover:text-accent-blue"
                    >
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-3">
          ...
          >
            ...
            <p className="mt-1 font-[family-name:var(--font-heading)] text-sm font-bold text-navy-100 group-hover:text-accent-blue">
              Complete GS Pay Scale Guide 2025
            </p>
