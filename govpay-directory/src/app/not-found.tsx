      ...
      <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          <Link
            key={link.href}
            href={link.href}
            className="flex items-center justify-center gap-2 rounded-xl border border-navy-700 bg-navy-900 px-4 py-3 text-sm text-navy-300 transition-all hover:border-accent-blue/50 hover:bg-navy-800 hover:text-accent-blue"
          >
            <link.icon size={16} />
            {link.label}
          </Link>
