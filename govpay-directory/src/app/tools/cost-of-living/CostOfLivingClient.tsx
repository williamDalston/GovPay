    ...
    <div className="mt-8 grid gap-6 lg:grid-cols-2">
      ...
      <div className="rounded-xl border border-navy-700 bg-navy-900 p-6">
        ...
        <div className="mt-4 space-y-4">
          <div>
            <label htmlFor="col-salary" className="block text-sm text-navy-400">
              Current Salary
            </label>
            <input
              id="col-salary"
              ...
              max={500000}
              step={1000}
              className="mt-1 w-full rounded-lg border border-navy-700 bg-navy-800 px-4 py-2.5 font-data text-lg text-navy-100 focus:border-accent-blue focus:outline-none"
            />
          </div>
          <div>
            <label htmlFor="col-from-city" className="block text-sm text-navy-400">From City</label>
            <select
              id="col-from-city"
              value={fromCity}
          ...
          <div>
            <label htmlFor="col-to-city" className="block text-sm text-navy-400">To City</label>
            <select
              id="col-to-city"
              value={toCity}
        ...
        <div className="mt-4 space-y-4">
          <div className="flex flex-col items-center gap-3 sm:flex-row sm:gap-4">
            <div className="w-full flex-1 rounded-lg bg-navy-800 p-4 text-center">
              ...
              <p className="mt-1 font-data text-lg font-bold text-navy-100 sm:text-xl">
            ...
            <div className="w-full flex-1 rounded-lg bg-navy-800 p-4 text-center">
              ...
              <p className="mt-1 font-data text-lg font-bold text-accent-green sm:text-xl">
          ...
          <div className="rounded-lg bg-navy-800 p-4 text-center">
            ...
            <p
              className={`mt-1 font-data text-2xl font-bold ${diff > 0 ? "text-accent-red" : diff < 0 ? "text-accent-green" : "text-navy-400"}`}
            >
              {diff > 0 ? "+" : ""}
              {formatCurrency(diff)}
            </p>
            <p className="mt-1 text-xs text-navy-400">
              {diff > 0
                ...
                : diff < 0
                  ...
                  : "Same cost of living — no adjustment needed"}
            </p>
          </div>
