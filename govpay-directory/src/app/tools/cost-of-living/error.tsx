...
export default function CostOfLivingError({ reset }: { reset: () => void }) {
  return (
    <div className="mx-auto max-w-3xl px-4 py-24 text-center sm:px-6 lg:px-8">
      <h1 className="font-heading text-2xl font-bold text-navy-100">
        Cost of Living Tool Unavailable
      </h1>
      <p className="mt-3 text-navy-400">
        Something went wrong loading the cost of living calculator. Please try
        again.
      </p>
